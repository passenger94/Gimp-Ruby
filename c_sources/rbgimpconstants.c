...
void register_enums(void)
{
  ...
  //g_type_init(); /* deprecated - does nothing, type system is automatically initialized now */
  gimp_enums_init();
  
  mEnum = rb_define_module_under(mGimp, "EnumNames");
      ...
      for (value = enum_class->values; value->value_name; value++)
        {
          ...
          name = value->value_name + 5;
          rbname = rb_str_new2(name);
          num = INT2NUM(value->value);
