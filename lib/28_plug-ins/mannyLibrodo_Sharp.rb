...
RubyFu.register(
  :name       => "ruby-fu-mannyLibrodo_sharp", #procedure name
  :blurb      => "manny Librodo's sharpening", #blurb
  :help       => "manny Librodo's sharpening", #help
  :author     => "xy", #author
  :copyright  => "xy", #copyright
  :date       => "2008", #date
  :menulabel   => "mannyLibrodo_sharp", #menulabel
