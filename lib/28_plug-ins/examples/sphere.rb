...
register(rfsphere) do |run_mode, radius, light, shadow, bg_color, sphere_color|
  include PDB::Access
...
menu_register("ruby-fu-sphere-xy", "<Image>/File/Create/RubyFu")
